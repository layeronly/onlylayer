...
import (
	...
	"github.com/onlylayer/onlylayer/command/server/config"
	"github.com/onlylayer/onlylayer/command/server/export"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the ONLY Network client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing ONLY Network client data",
	)
