...
build:
	...
	go build -o onlylayer -ldflags="\
    	-X 'github.com/onlylayer/onlylayer/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/onlylayer/onlylayer/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/onlylayer/onlylayer/versioning.Branch=$(BRANCH)'\
		-X 'github.com/onlylayer/onlylayer/versioning.BuildTime=$(TIME)'" \
	main.go
...
test-e2e:
	...
	go build -race -o artifacts/onlylayer .
	env EDGE_BINARY=${PWD}/artifacts/onlylayer go test -v -timeout=30m ./e2e/...
